...
class HomePage extends StatelessWidget {
                            ...
                            child: Column(
                              children: [
                                ...
                                _transactionList(
                                    ...
                                    'assets/icons/triangle_down.png',
                                    'Startbucks Drinks!',
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                sub,
                style: kCaption.copyWith(color: kLuckyBlue),
              ),
            ],
          ),
          Spacer(),
  ...
  Widget _transactionButton(String icon, String text) {
    return Expanded(
      child: Container(
        constraints: BoxConstraints.expand(height: 60, width: 165),
        decoration: BoxDecoration(
            color: kNightBlack,
